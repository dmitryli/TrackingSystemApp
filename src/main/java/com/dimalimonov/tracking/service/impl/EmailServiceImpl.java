...
public class EmailServiceImpl implements EmailService {
	...
	private final static String WELCOME_TEXT = DEAR_CUSTOMER + FROM + " team welcomes you to the service!\nYour account number is %s";
	...
	private final static String NEW_ORDER_TEXT = DEAR_CUSTOMER + "The package %s is now monitored and latest update is: \n%s";
	...
	public void sendWeclomeEmail(Account account) {
		...
		String welcomeText = String.format(WELCOME_TEXT, account.getProfile().getUserName(), account.getId());
	...
	public void sendGoodByeEmail(Account account) {
		...
		String welcomeText = String.format(GOODBYE_TEXT, account.getProfile().getUserName(), account.getId());
		message.setText(welcomeText);
	...
	public void sendNewOrderEmail(Account account, String id, String status) {
		...
		String newOrder = String.format(NEW_ORDER_TEXT, account.getProfile().getUserName(), id, status);
	...
	public void sendNotificationEmail(Account account, String id, String status) {
		...
		String notifyTextOrder = String.format(NOTIFICATION_TEXT, account.getProfile().getUserName(), id, status);
	...
	public void sendThresholdExceededEmail(Account account, String id, String status) {
		...
		String notifyTextOrder = String.format(THRESHOLD_TEXT, account.getProfile().getUserName(), id, status);
		message.setText(notifyTextOrder);
